...
extern void dfabuild PARAMS ((struct dfa *));

void dfaprint PARAMS ((struct dfa *d));

void dfaaddpatt PARAMS ((struct dfa *d, char *pattern, unsigned int length));

int dfamatch PARAMS ((struct dfa *d, unsigned char *buffer, unsigned int size));

int dfamatch_dispatch PARAMS ((struct dfa *d, unsigned char *buffer, unsigned int size, void (*callback)(void *user, const unsigned int offset), void *user));

int dfamatch_linear PARAMS ((int *trans, unsigned char *buffer, unsigned int size));
