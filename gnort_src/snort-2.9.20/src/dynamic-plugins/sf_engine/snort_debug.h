...
void DebugWideMessageFunc(uint64_t dbg, const wchar_t *fmt, ...);
    ...
    #define    DebugMessage    *_ded.debugMsgFile = __FILE__; *_ded.debugMsgLine = __LINE__; _ded.debugMsg
    #define    DebugWideMessage    *_ded.debugMsgFile = __FILE__; *_ded.debugMsgLine = __LINE__; _ded.debugWideMsg
