...
/* Define to 1 if you have the declaration of `PACKET_TX_RING', and to 0 if
   you don't. */
#define HAVE_DECL_PACKET_TX_RING 1

/* Define to 1 if you have the declaration of `TPACKET2_HDRLEN', and to 0 if
   you don't. */
#define HAVE_DECL_TPACKET2_HDRLEN 1
...
#define PACKAGE_STRING "daq 2.0.7"
